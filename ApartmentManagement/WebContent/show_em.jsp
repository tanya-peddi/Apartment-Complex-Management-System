...
ResultSet rs = st.executeQuery("SELECT first_name,last_name,email,employee_id,pass,phone_number FROM employee INNER JOIN user_login on employee_id=user_id");
while(rs.next())
{
%>
<tr bgcolor="#DEB887">
